...
class CourseMode(models.Model):
    ...
    # The price in inr that we would like to charge for this mode of the course
...
class CourseModesArchive(models.Model):
    ...
    # minimum price in inr that we would like to charge for this mode of the course
