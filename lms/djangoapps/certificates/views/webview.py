...
def _update_context_with_user_info(context, user, user_certificate):
    ...
    """
    # user_fullname = get_preferred_certificate_name(user) or user.get_full_name() or user.username
    user_fullname = user_certificate.name or user.profile.name or user.username
