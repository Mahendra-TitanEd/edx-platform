...
BC_CLIENT_ID = ENV_TOKENS.get('BC_CLIENT_ID', "")
BC_CLIENT_SECRET = ENV_TOKENS.get('BC_CLIENT_SECRET', "")
BC_ACCOUNT_ID = ENV_TOKENS.get('BC_ACCOUNT_ID', "")
API_CREATE_COLLEGE = ENV_TOKENS.get('API_CREATE_COLLEGE', "")
API_UPDATE_COLLEGE = ENV_TOKENS.get('API_UPDATE_COLLEGE', "")
API_CREATE_USER = ENV_TOKENS.get('API_CREATE_USER', "")
API_UPDATE_USER = ENV_TOKENS.get('API_UPDATE_USER', "")
API_RESET_EMAIL = ENV_TOKENS.get('API_RESET_EMAIL', "")
API_RESEND_EMAIL = ENV_TOKENS.get('API_RESEND_EMAIL', "")
API_GROUP_JWT_KEY = ENV_TOKENS.get('API_GROUP_JWT_KEY', "")
API_COURSE_PURCHASE_JWT_KEY = ENV_TOKENS.get('API_COURSE_PURCHASE_JWT_KEY', "")
INTERNAL_API_JWT_KEY = ENV_TOKENS.get('INTERNAL_API_JWT_KEY', "")
...
MAILCHIMP_SERVER_PREFIX = ENV_TOKENS.get('MAILCHIMP_SERVER_PREFIX', "")
MAILCHIMP_AUDIENCE_ID = ENV_TOKENS.get('MAILCHIMP_AUDIENCE_ID', "")